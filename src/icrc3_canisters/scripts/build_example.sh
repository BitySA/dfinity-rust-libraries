...
cp "./canisters/icrc3_example/target/wasm32-unknown-unknown/release/icrc3_example_canister.wasm.gz" "./wasm/icrc3_example_canister.wasm.gz"
cp "./canisters/icrc3_archive/target/wasm32-unknown-unknown/release/icrc3_archive_canister.wasm.gz" "../icrc3/wasm/icrc3_archive_canister.wasm.gz"
